...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section id="infinite" class="text-white tm-font-big tm-parallax">
      ...
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">              
        <div class="container">   
          <div class="tm-next">
              <a href="#infinite" class="navbar-brand">Easy to Live</a>
          </div>             
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#contact">Singin/Singup</a>
              </li>
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">Easy to Live</h2>
    ...
    <section id="contact" class="tm-section-pad-top tm-parallax-2">
        <div style="text-align: center;">
            <a href="{{ url('login') }}" ><input style="border-radius: 10px; height: 5%; width: 70%;background-color: transparent; color: white;border-color: yellow;" type="button" value="Sing In As Seller"></a>
            <a href=""><input style="border-radius: 10px; height: 5%; width: 70%;background-color: transparent; color: white;border-color: yellow;" type="button" value="Sing In As Byer"></a>
            <a href="{{ url('register') }}"><input style="border-radius: 10px; height: 5%; width: 70%;background-color: transparent; color: white;border-color: yellow;" type="button" value="Create Account for Sell"></a>
            <a href=""><input style="border-radius: 10px; height: 5%; width: 70%;background-color: transparent; color: white;border-color: yellow;" type="button" value="Create Account for Bye"></a>
        </div>
        <br>
        <br>
    ...
    <script>
      ...
      $(function(){
       ...
       <!--  <div >
        ...
        <div class="list">
            <li class="list-item"><a href="{{url('about')}}"></a>about</li>
